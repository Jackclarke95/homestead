...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeExporter) {
        ...
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Items.APPLE), Items.WHEAT.getDefaultStack(), 120)
                ...
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.STONE_BRICKS),
                ...
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Items.POISONOUS_POTATO),
        ...
        PressingRecipeJsonBuilder
                ...
                .secondaryMode(SecondaryMode.INSTEAD)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.DEEPSLATE_BRICKS),
                ...
                .secondaryMode(SecondaryMode.INSTEAD)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.DEEPSLATE_TILES),
                ...
                .secondaryMode(SecondaryMode.INSTEAD)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.NETHER_BRICKS),
        ...
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.POLISHED_BLACKSTONE_BRICKS),
                ...
                .secondaryMode(SecondaryMode.INSTEAD)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.STONE),
                ModBlocks.STONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.COARSE_DIRT),
                ModBlocks.COARSE_DIRT_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.COBBLESTONE),
                ModBlocks.COBBLESTONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(ModBlocks.COBBLESTONE_BRICKS),
                ModBlocks.COBBLESTONE_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.ANDESITE),
                ModBlocks.ANDESITE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.POLISHED_ANDESITE),
                ModBlocks.POLISHED_ANDESITE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.DIORITE),
                ModBlocks.DIORITE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.POLISHED_DIORITE),
                ModBlocks.POLISHED_DIORITE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.GRANITE),
                ModBlocks.GRANITE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.POLISHED_GRANITE),
                ModBlocks.POLISHED_GRANITE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.GRAVEL),
                ModBlocks.GRAVEL_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.OAK_PLANKS),
                ModBlocks.OAK_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.SPRUCE_PLANKS),
                ModBlocks.SPRUCE_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.BIRCH_PLANKS),
                ModBlocks.BIRCH_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.JUNGLE_PLANKS),
                ModBlocks.JUNGLE_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.ACACIA_PLANKS),
                ModBlocks.ACACIA_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.DARK_OAK_PLANKS),
                ModBlocks.DARK_OAK_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.MANGROVE_PLANKS),
                ModBlocks.MANGROVE_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.CHERRY_PLANKS),
                ModBlocks.CHERRY_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.BAMBOO_PLANKS),
                ModBlocks.BAMBOO_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.CRIMSON_PLANKS),
                ModBlocks.CRIMSON_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.WARPED_PLANKS),
                ModBlocks.WARPED_PLANK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.MOSSY_COBBLESTONE),
                ModBlocks.MOSSY_COBBLESTONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.MOSSY_STONE_BRICKS),
                ModBlocks.MOSSY_STONE_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.SMOOTH_STONE),
                ModBlocks.SMOOTH_STONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.CHISELED_STONE_BRICKS),
                ModBlocks.CHISELED_STONE_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.DEEPSLATE),
                ModBlocks.DEEPSLATE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.COBBLED_DEEPSLATE),
                ModBlocks.COBBLED_DEEPSLATE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.POLISHED_DEEPSLATE),
                ModBlocks.POLISHED_DEEPSLATE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.POLISHED_TUFF),
                ModBlocks.POLISHED_TUFF_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.TUFF_BRICKS),
                ModBlocks.TUFF_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.BRICKS),
                ModBlocks.BRICKS_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.PACKED_MUD),
                ModBlocks.PACKED_MUD_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.MUD_BRICKS),
                ModBlocks.MUD_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.SMOOTH_SANDSTONE),
                ModBlocks.SMOOTH_SANDSTONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.SMOOTH_RED_SANDSTONE),
                ModBlocks.SMOOTH_RED_SANDSTONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.PRISMARINE),
                ModBlocks.PRISMARINE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.PRISMARINE_BRICKS),
                ModBlocks.PRISMARINE_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.DARK_PRISMARINE),
                ModBlocks.DARK_PRISMARINE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.NETHERRACK),
                ModBlocks.NETHERRACK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.CHISELED_NETHER_BRICKS),
                ModBlocks.CHISELED_NETHER_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.RED_NETHER_BRICKS),
                ModBlocks.RED_NETHER_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.SMOOTH_BASALT),
                ModBlocks.SMOOTH_BASALT_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.BLACKSTONE),
                ModBlocks.BLACKSTONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.GILDED_BLACKSTONE),
        ...
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.CHISELED_POLISHED_BLACKSTONE),
                ...
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.POLISHED_BLACKSTONE),
                ModBlocks.POLISHED_BLACKSTONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.END_STONE),
                ModBlocks.END_STONE_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.END_STONE_BRICKS),
                ModBlocks.END_STONE_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.PURPUR_BLOCK),
                ModBlocks.PURPUR_BLOCK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.PURPUR_PILLAR),
                ModBlocks.PURPUR_PILLAR_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.QUARTZ_BLOCK),
                ModBlocks.QUARTZ_BLOCK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.CHISELED_QUARTZ_BLOCK),
                ModBlocks.CHISELED_QUARTZ_BLOCK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.QUARTZ_BRICKS),
                ModBlocks.QUARTZ_BRICK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        PressingRecipeJsonBuilder.create(Ingredient.ofItems(Blocks.SMOOTH_QUARTZ),
                ModBlocks.SMOOTH_QUARTZ_BLOCK_PATH.asItem().getDefaultStack(), 120)
                .offerTo(recipeExporter);
        // #endregion Pressing Recipes

        // #region Sowing Recipes
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.APPLE_SEEDS),
                ModBlocks.APPLE_TREE_SAPLING.asItem().getDefaultStack(), 200)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.PEAR_SEEDS),
                ModBlocks.PEAR_TREE_SAPLING.asItem().getDefaultStack(), 200)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.PLUM_SEEDS),
                ModBlocks.PLUM_TREE_SAPLING.asItem().getDefaultStack(), 200)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.LEMON_SEEDS),
        ...
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.ALLIUM_SEEDS),
                Blocks.ALLIUM.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.AZURE_BLUET_SEEDS),
                Blocks.AZURE_BLUET.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.BLUE_ORCHID_SEEDS),
                Blocks.BLUE_ORCHID.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
        ...
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.LILY_OF_THE_VALLEY_SEEDS),
                ...
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.ORANGE_TULIP_SEEDS),
                Blocks.ORANGE_TULIP.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.OXEYE_DAISY_SEEDS),
                Blocks.OXEYE_DAISY.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.PINK_TULIP_SEEDS),
                Blocks.PINK_TULIP.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.POPPY_SEEDS),
                Blocks.POPPY.asItem().getDefaultStack(), 100).offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.RED_TULIP_SEEDS),
                Blocks.RED_TULIP.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
        SowingRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.WHITE_TULIP_SEEDS),
                Blocks.WHITE_TULIP.asItem().getDefaultStack(), 100)
                .offerTo(recipeExporter);
