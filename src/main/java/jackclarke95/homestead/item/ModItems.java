...
public class ModItems {
    ...
    public static final Item ALLIUM_SEEDS = registerItem("allium_seeds",
            new Item(new Item.Settings()));
    public static final Item AZURE_BLUET_SEEDS = registerItem("azure_bluet_seeds",
            new Item(new Item.Settings()));
    public static final Item BLUE_ORCHID_SEEDS = registerItem("blue_orchid_seeds",
            new Item(new Item.Settings()));
    ...
    public static final Item ORANGE_TULIP_SEEDS = registerItem("orange_tulip_seeds",
            new Item(new Item.Settings()));
    public static final Item OXEYE_DAISY_SEEDS = registerItem("oxeye_daisy_seeds",
            new Item(new Item.Settings()));
    public static final Item PINK_TULIP_SEEDS = registerItem("pink_tulip_seeds",
            new Item(new Item.Settings()));
    public static final Item POPPY_SEEDS = registerItem("poppy_seeds",
            new Item(new Item.Settings()));
    public static final Item RED_TULIP_SEEDS = registerItem("red_tulip_seeds",
            new Item(new Item.Settings()));
    public static final Item WHITE_TULIP_SEEDS = registerItem("white_tulip_seeds",
            new Item(new Item.Settings()));
    ...
    public static void registerModItems() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.NATURAL).register(entries -> {
            ...
            entries.add(PINK_TULIP_SEEDS);
            entries.add(POPPY_SEEDS);
            entries.add(RED_TULIP_SEEDS);
            entries.add(WHITE_TULIP_SEEDS);
        });
