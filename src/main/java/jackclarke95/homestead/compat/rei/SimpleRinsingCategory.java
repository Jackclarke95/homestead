...
public class SimpleRinsingCategory implements DisplayCategory<SimpleRinsingDisplay> {
    public static final CategoryIdentifier<SimpleRinsingDisplay> ID = CategoryIdentifier.of(Homestead.MOD_ID,
            "rinsing");

    @Override
    public CategoryIdentifier<? extends SimpleRinsingDisplay> getCategoryIdentifier() {
        return ID;
    }
    ...
    public Text getTitle() {
        return Text.translatable("category." + Homestead.MOD_ID + ".rinsing");
    }

    @Override
    public int getDisplayWidth(SimpleRinsingDisplay display) {
        return 110;
    }
    ...
    @Override
    public List<Widget> setupDisplay(SimpleRinsingDisplay display, Rectangle bounds) {
