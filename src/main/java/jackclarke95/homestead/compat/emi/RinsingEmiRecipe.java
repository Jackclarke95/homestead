...
public class RinsingEmiRecipe implements EmiRecipe {
    private final Identifier id;
    private final RinsingRecipe recipe;
    private final EmiIngredient input;
    private final EmiStack output;

    public RinsingEmiRecipe(Identifier id, RinsingRecipe recipe) {
        this.id = id;
        this.recipe = recipe;
    ...
    public EmiRecipeCategory getCategory() {
        return HomesteadEmiPlugin.RINSING_CATEGORY;
    }
